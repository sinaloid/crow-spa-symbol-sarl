                ...
                <>
                    <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3">
                        ...
                        <CardInfo
                            ...
                            title="Finan. en cours"
                            data={
                                data &&
                                Intl.NumberFormat().format(data.total_vente)
                            }
                        />
                        ...
                        <CardInfo
                            ...
                            title="Finan. terminer"
                            data={
                                data &&
                                Intl.NumberFormat().format(data.total_depense)
                            }
                        />
                    </div>
                ...
                {autorisation(
                    <div className="col">
                        <div className="card o-hidden mb-4">
                            ...
                            <div>
                                <div className="table-responsive">
                                    <CustomerTable clientType={"investisseur"} />
                                </div>
                            </div>
                        </div>
                        <div className="card o-hidden mb-4">
